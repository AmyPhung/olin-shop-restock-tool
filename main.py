...
def updateCSV(url, filename):
    sheets = Sheets.from_files('keys/client_secrets.json', 'keys/storage.json')
    s = sheets.get(url)
    s.sheets[1].to_csv(filename, encoding='utf-8', dialect='excel')
...
if __name__ == "__main__":
    updateCSV('https://docs.google.com/spreadsheets/d/1FqDo6pPHvlgrsp8z4VJyQzSa6x8cxxIfXJ09ugByXi4/edit?usp=sharing',
              'output/autogenerated_inventory.csv')
    inventory = pd.read_csv('output/autogenerated_inventory.csv')
